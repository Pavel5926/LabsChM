...
matrix_t::matrix_t(int h, int w) {
    rows = h;
    cols = w;
    data = std::vector<double>(h * w);
}

double& matrix_t::operator()(int i, int j) { return el(i, j); }
double matrix_t::operator()(int i, int j) const { return el(i, j); }
double& matrix_t::el(int i, int j) { return data[i * cols + j]; }
double matrix_t::el(int i, int j) const { return data[i * cols + j]; }
double& matrix_t::operator[](const int i) { return data[i]; }
double matrix_t::operator[](const int i) const { return data[i]; }
